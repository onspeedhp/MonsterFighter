 ...
 */
public class Shop {
    private ArrayList<Item> itemForSell;
     ...
     * @see GameItem
     */
    public void addItemForSell(Item item) {
    ...
    public Item sellItem(int index) {
        Item purchasedItem = this.itemForSell.get(index);
        this.itemForSell.remove(index);
        return purchasedItem;
    }

    /* getters go here */
    public ArrayList<Item> getItemForSell() {
